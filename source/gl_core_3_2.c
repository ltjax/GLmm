...
/** File generated from command line: -style=pointer_c -spec=gl -version=3.2 -profile=core core_3_2 -geninfo version cmdline -exts ARB_debug_output ARB_get_program_binary INTEL_framebuffer_CMAA**/
...
int ogl_ext_INTEL_framebuffer_CMAA = ogl_LOAD_FAILED;
...
void (CODEGEN_FUNCPTR *_ptrc_glApplyFramebufferAttachmentCMAAINTEL)(void) = NULL;

static int Load_INTEL_framebuffer_CMAA(void)
{
	int numFailed = 0;
	_ptrc_glApplyFramebufferAttachmentCMAAINTEL = (void (CODEGEN_FUNCPTR *)(void))IntGetProcAddress("glApplyFramebufferAttachmentCMAAINTEL");
	if(!_ptrc_glApplyFramebufferAttachmentCMAAINTEL) numFailed++;
	return numFailed;
}
...
static ogl_StrToExtMap ExtensionMap[3] = {
	...
	{"GL_INTEL_framebuffer_CMAA", &ogl_ext_INTEL_framebuffer_CMAA, Load_INTEL_framebuffer_CMAA},
};
...
static void ClearExtensionVars(void)
{
	...
	ogl_ext_INTEL_framebuffer_CMAA = ogl_LOAD_FAILED;
}
