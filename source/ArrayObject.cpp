...
void GLmm::ArrayObject::Bind() const
{
...
void GLmm::ArrayObject::Unbind() const
{
    glBindVertexArray(0);
    GLMM_CHECK_ERRORS();
}

GLmm::ArrayObject& GLmm::ArrayObject::SetElementBuffer(GLmm::BufferObject const& ElementBuffer)
{
    Bind();
...
GLmm::ArrayObject& GLmm::ArrayObject::SetAttribPointer(int Location,
                                                       ...
                                                       std::size_t Offset)
{
    ...
    glVertexAttribPointer(Location, Size, Type, Normalized ? GL_TRUE : GL_FALSE, boost::numeric_cast<GLsizei>(Stride),
...
void GLmm::ArrayObject::DrawRangeElements(
    GLenum Mode, GLuint Start, GLuint End, GLsizei Count, GLenum Type, std::size_t Offset) const
{
    Bind();
...
void GLmm::ArrayObject::DrawRangeElementsBaseVertex(
    GLenum Mode, GLuint Start, GLuint End, GLsizei Count, GLenum Type, std::size_t Offset, GLint BaseVertex) const
{
    Bind();
