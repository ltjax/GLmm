...
class ArrayObject : public boost::noncopyable
{
public:
    ArrayObject();
    ...
    ArrayObject& SetElementBuffer(GLmm::BufferObject const& ElementBuffer);

    ArrayObject& SetAttribPointer(GLint Location,
    ...
    ArrayObject& SetAttribPointer(int Location, GLmm::BufferObject const& Buffer, M(T::*Member))
    {
